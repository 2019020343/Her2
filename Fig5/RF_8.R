...
#write.table(roc,"D:\\her2\\fig\\5\\ROC\\F8_RF_ROC.txt",col.names = T, row.names = F,sep = "\t" ,append = FALSE, quote = F)
roc<- read.table("D:\\HER2\\fig\\5\\ROC\\F8_RF_ROC.txt",header = T,sep = "\t")
